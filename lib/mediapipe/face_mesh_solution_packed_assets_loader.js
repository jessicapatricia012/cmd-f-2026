  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      if (!Module['locateFile'] && typeof document === 'object' && document.currentScript && document.currentScript.src) {
        REMOTE_PACKAGE_NAME = new URL(REMOTE_PACKAGE_BASE, document.currentScript.src).toString();
      }
